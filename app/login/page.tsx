    ...
    <>
      <form onSubmit={handleLogin} className="space-y-4">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full py-3.5 bg-gradient-to-r from-[#FF6B00] to-[#FF4500] text-white font-bold rounded-xl shadow-orange hover:shadow-orange-lg transition-all hover:-translate-y-0.5 disabled:opacity-60 disabled:cursor-not-allowed"
        >
          {loading ? (
      ...
      {/* Demo Credentials */}
      <div className="mt-6 p-5 bg-orange-50 border border-[#FF6B00]/20 rounded-2xl">
        <p className="text-xs font-bold text-[#FF6B00] mb-3 tracking-widest">
          DEMO ACCOUNT
        </p>
        <div className="space-y-2 text-sm">
          <div className="flex justify-between">
            <span className="text-gray-600">Email:</span>
            <span className="font-mono font-medium">admin@skillsphere.com</span>
          </div>
          <div className="flex justify-between">
